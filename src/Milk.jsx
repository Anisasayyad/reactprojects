...
// function Milkshakes() {
//   const milkshakes = useSelector(globalstate => globalstate.products.milkshakes);
...
//     toast.success(`Product "${product.name}" (ID: ${product.id}) added to cart successfully 🛒`, {
//       position: "top-right",
//       autoClose: 2000,
//     });
//   };
...
//     }}>
//       <h2 style={{ textAlign: "center", marginBottom: "20px" }}>Milkshake Items</h2>
